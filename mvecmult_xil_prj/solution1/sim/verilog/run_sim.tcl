...
if {[file isfile mvecmult.autotvin.dat]} {
	file delete -force mvecmult.autotvin.dat
}

if {[file isfile mvecmult.autotvout.dat]} {
	file delete -force mvecmult.autotvout.dat
}
