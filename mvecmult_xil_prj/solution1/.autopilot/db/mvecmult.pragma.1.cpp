...
void mvecmult(int A[256][256], int v[256], int result[256]) {_ssdm_SpecArrayDimSize(A, 256);_ssdm_SpecArrayDimSize(v, 256);_ssdm_SpecArrayDimSize(result, 256);
_ssdm_SpecArrayPartition( A, 2, "CYCLIC", 8, "");

_ssdm_SpecArrayPartition( v, 1, "COMPLETE", 0, "");
